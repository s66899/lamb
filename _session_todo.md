...
- **NSCA-CPT ch10 SMR 5202-5213 入库状态** → **本轮已确认 12 个 id 全部在库**（v3.22.17 兑现）；下轮可删 todo
...
- **羽毛球 ch12 第九节 / NSCA-CPT ch10 第七节**：H4 子节同样使用「#### 第一层」「#### 第二层」截断风格，可参照本轮 ch09 修复手法做统一
